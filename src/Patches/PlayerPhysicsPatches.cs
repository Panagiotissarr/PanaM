...
public static class PlayerPhysics_LateUpdate
{
    ...
    {
        PanaMESP.PlayerNametags(__instance);
        PanaMESP.SeeGhostsCheat(__instance);

        PanaMCheats.NoClipCheat();
        PanaMCheats.ProtectCheat();
        PanaMCheats.KillAllCheat();
        PanaMCheats.KillAllCrewCheat();
        PanaMCheats.KillAllImpsCheat();
        PanaMCheats.ForceStartGameCheat();
        PanaMCheats.TeleportCursorCheat();
        PanaMCheats.CompleteMyTasksCheat();
        PanaMCheats.PlayAnimationCheat();
        PanaMCheats.PlayScannerCheat();

        PanaMPPMCheats.EjectPlayerPPM();
        PanaMPPMCheats.SpectatePPM();
        PanaMPPMCheats.KillPlayerPPM();
        PanaMPPMCheats.TelekillPlayerPPM();
        PanaMPPMCheats.TeleportPlayerPPM();
        PanaMPPMCheats.SetFakeRolePPM();
        PanaMPPMCheats.SetFakeAlivePPM();
        // PanaMPPMCheats.ForceRolePPM();
