...
public static class HudManager_Update
{
	public static void Postfix(HudManager __instance)
    {
		__instance.ShadowQuad.gameObject.SetActive(!PanaMESP.IsFullbrightActive()); // Fullbright
		...
		PanaMCheats.UseVentCheat(__instance);
		PanaMESP.ZoomOut(__instance);
		PanaMESP.FreecamCheat();
