...
public static class Utils
{
    ...
    public static Sprite LoadSprite(string path, float pixelsPerUnit = 1f)
    {
        ...
        {
            PanaM.Log.LogError($"Failed to read Texture: {path}");
        }
        return null;
    }
    ...
    {
        var configFilePath = PanaM.Plugin.Config.ConfigFilePath;
        var configEditor = PanaM.configEditor.Value;
        ...
        if (!string.IsNullOrWhiteSpace(configEditor))
        {
            if (File.Exists(configFilePath))
            {
                ...
                {
                    PanaM.Log.LogError(ex.Message);
                }
            }
            else
            {
                PanaM.Log.LogError("Configuration file does not exist");
            }
        }
        else
        {
            PanaM.Log.LogError("Configuration editor not specified");
        }
    }
    ...
    public class PanicCleaner : MonoBehaviour
    {
        ...
        public static void Create()
        {
            ...
            var go = new GameObject("PanaM_PanicCleaner");
        ...
        {
            try { Harmony.UnpatchID(PanaM.Id); } catch { }
            Destroy(gameObject);
        }
    }
    ...
    public static void Panic()
    {
        ...
        UnityEngine.Object.Destroy(PanaM.menuUI);

        UnityEngine.Object.Destroy(PanaM.consoleUI);
        UnityEngine.Object.Destroy(PanaM.doorsUI);
        UnityEngine.Object.Destroy(PanaM.tasksUI);
        UnityEngine.Object.Destroy(PanaM.protectUI);
        // UnityEngine.Object.Destroy(PanaM.rolesUI);
        // UnityEngine.Object.Destroy(PanaM.overloadUI);
